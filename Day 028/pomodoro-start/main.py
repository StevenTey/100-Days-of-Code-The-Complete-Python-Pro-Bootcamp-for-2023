...
def count_down(count):
    ...
    if count > 0:
        ...
        start_timer()
        reps_label = math.floor(reps/2)
        mark = ""
        for _ in range(reps_label):
            markt += "✔"
...
tomato_img = PhotoImage(file="/Users/steven.tey/Documents/Python Bootcamp/Day 028/pomodoro-start/tomato.png")
